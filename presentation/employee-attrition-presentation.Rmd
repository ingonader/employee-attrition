...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/model-fit-all-eval.jpg")
```
...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/model-fit-all-test.jpg")
```
...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/model-fit-all-evaltest.jpg")
```
...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/feat-eff-overtime-glmnet.jpg")
```
...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/feat-eff-jobrole-glmnet.jpg")
```
...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/feat-eff-environmentsatisfaction-glmnet.jpg")
```
...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/feat-eff-businesstravel-glmnet.jpg")
```
...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/feat-eff-totalworkingyears-glmnet.jpg")
```
...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/feat-eff-numcompaniesworked-glmnet.jpg")
```
...
```{r, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = "left"}
knitr::include_graphics("../img/feat-eff-worklifebalance-glmnet.jpg")
```
